...
public class DtoPCHException extends RuntimeException{
	...
	public DtoPCHException(String mensajeTecnico,String mensajeUsuario, Lugar lugar, Throwable excepcionRaiz) {
		super(mensajeTecnico,excepcionRaiz);
		setMensajeUsuario  (mensajeUsuario);
		setLugar (lugar);
	}
	
	public DtoPCHException(final String mensajeUsuario,final Lugar lugar) {
